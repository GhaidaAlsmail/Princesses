...
// //   /// 1. دالة اختيار الملف ومعاينته في الجدول
...
// //     // تفعيل مؤشر التحميل وقفل الأزرار لمنع التعليق
// //     setState(() => _isLoading = true);
// //     debugPrint(" بدأت عملية الرفع السحابي الحميّة...");
...
// //         );
// //       }
// //       debugPrint(" تم رفع جميع المعازيم ($count) إلى الفايربيز بنجاح!");

// //       // 3. الانتقال الآمن لشاشة الماسح الذكي
// //       if (mounted) {
// //         _showSnackBar(" تم إنشاء المناسبة وحفظ جميع الضيوف بنجاح!");
...
// //         // استخدام حماية لمحاولة الانتقال لمنع تعليق الـ Router
// //         try {
...
// //         ),
// //         centerTitle: true,
// //         backgroundColor: Color.fromARGB(255, 204, 69, 145),
// //       ),
// //       body: Padding(
...
//   /// 2. دالة التأكيد والرفع السحابي مع توليد بيانات الباركود/QR
//   Future<void> _confirmAndUpload() async {
//     if (_eventNameController.text.trim().isEmpty) {
//       _showSnackBar("الرجاء إدخال اسم الحفلة أولاً");
//       return;
