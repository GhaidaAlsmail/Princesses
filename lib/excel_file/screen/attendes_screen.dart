...
//                   ),
//                   // 📏 زيادة ارتفاع السطر ليتسع لمربع الـ QR بوضوح
//                   dataRowMinHeight: 70,
//                   dataRowMaxHeight: 80,
//                   columns: const [
//                     DataColumn(
...
//                     String attendeeId = doc.id; // معرّف الشخص الافتراضي

//                     // 💡 هنا نحدد النص الذي سيُشفر داخل الـ QR
//                     // يفضّل استخدام الـ id الخاص بالمستند أو حقل الـ 'code' إذا كنتِ قمتِ بتوليده مسبقاً
...
//                         // 🖼️ خلاصة التعديل: عرض الـ QR Code داخل الخلية ليصبح قابلاً للمسح
//                         DataCell(
//                           IconButton(
//                             icon: const Icon(
//                               Icons.qr_code_2,
...
//                             ),
//                             onPressed: () {
//                               // فتح نافذة منبثقة تعرض الباركود بوضوح تام للمسح
//                               showDialog(
//                                 context: context,
